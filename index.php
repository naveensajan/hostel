...
<body style="background-color:rgb(112, 175, 138);">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="Student.php">Sign Up</a>
              </li>
           </div>
        </div>
      </nav>
        ...
        <div class="row">
            <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
              ...
              <div class="col col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                <tr>
   <td bgcolor="white" > 
      <h1><font style="font-background-color:white; font-family:cursive; font-size:30px;color:rgb(94, 74, 117);"><b><center>RCSS Hostel</center> </b>
    </h1>
  </tr>
</td>
</div>
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="img-thumbnail" src="pics/2.jpg" class="d-block w-100" alt="...">
                </div>
              </div></div>
          </div>
                ...
                <table class="table table-borderless">
                  ...
                  <tr>
                    <td></td>
                            ...
                            <td></td>
                             <td> <h1 style="font-family:cursive;font-size:30px;color:rgb(35, 63, 52);">Login</h1>
                             </td>
                             </tr>
                             <tr>
                               <td></td>
